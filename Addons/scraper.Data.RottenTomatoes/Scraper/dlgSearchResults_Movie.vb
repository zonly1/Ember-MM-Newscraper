...
#Region "Fields"
    ...
    Private TMDB As RottenTomatoes.Scraper
    Private sHTTP As New HTTP
    Private _currnode As Integer = -1
    Private _prevnode As Integer = -2
    Private MySettings As RottenTomatoes.Scraper.sMySettings_ForScraper
...
#Region "Methods"
    ...
    Public Sub New(_MySettings As RottenTomatoes.Scraper.sMySettings_ForScraper, _TMDB As RottenTomatoes.Scraper)
    ...
    Public Overloads Function ShowDialog(ByRef nMovie As MediaContainers.Movie, ByVal Res As RottenTomatoes.SearchResults_Movie, ByVal sMovieTitle As String, ByVal sMovieFilename As String) As Windows.Forms.DialogResult
        Me.tmrWait.Enabled = False
        Me.tmrWait.Interval = 250
        Me.tmrLoad.Enabled = False
        Me.tmrLoad.Interval = 100
    ...
    Private Sub SearchResultsDownloaded(ByVal M As RottenTomatoes.SearchResults_Movie)
        Try
